"""
Study 3 (on-demand/required map tools vs. baseline) -- input-tokens
violin plot broken out by BOTH model (x-axis clusters) and map condition
(one violin per condition within each cluster), same layout as
figures/scripts/plot_study2_tokens_by_model_violinplot.py. Colour encodes
map condition (same fixed categorical hues as every other Study 3
...
figures/scripts/plot_study3_tokens_violinplot.py, to avoid matplotlib's
scientific-notation axis offset.

Reads data/compiled_results_combined.pkl directly.
Writes figures/study3_tokens_by_model_violinplot.png.

Usage:
    python3 figures/scripts/plot_study3_tokens_by_model_violinplot.py
"""
import os
...
OUT_PNG = os.path.join(_ROOT, "figures", "study3_tokens_by_model_violinplot.png")
