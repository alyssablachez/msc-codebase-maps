"""
Study 3 (on-demand/required map tools vs. baseline) -- pooled turns-used
violin plot by map condition, same convention as
figures/scripts/plot_study1_turns_violinplot.py and
figures/scripts/plot_study2_turns_violinplot.py. `baseline` is Study 1's
shared cross-study control.

Reads data/compiled_results_combined.pkl directly.
Writes figures/study3_turns_violinplot.png.

Usage:
    python3 figures/scripts/plot_study3_turns_violinplot.py
"""
import os
...
OUT_PNG = os.path.join(_ROOT, "figures", "study3_turns_violinplot.png")
