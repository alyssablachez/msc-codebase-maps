"""
Study 3 (on-demand/required map tools vs. baseline) -- pooled cost
violin plot by map condition, same convention as
figures/scripts/plot_study1_cost_violinplot.py and
figures/scripts/plot_study2_cost_violinplot.py. `baseline` is Study 1's
shared cross-study control.

Reads data/compiled_results_combined.pkl directly.
Writes figures/study3_cost_violinplot.png.

Usage:
    python3 figures/scripts/plot_study3_cost_violinplot.py
"""
import os
...
OUT_PNG = os.path.join(_ROOT, "figures", "study3_cost_violinplot.png")
