"""
Study 1 -- pooled turns-used violin plot by map condition, same convention
as plot_study1_f1_violinplot.py. Descriptive companion to the negative-binomial
turns model (test #8 in the agreed battery, not yet built).

Reads data/compiled_results_combined.pkl directly.
Writes figures/study1_turns_violinplot.png.

Usage:
    python3 figures/scripts/plot_study1_turns_violinplot.py
"""
import os
...
OUT_PNG = os.path.join(_ROOT, "figures", "study1_turns_violinplot.png")
