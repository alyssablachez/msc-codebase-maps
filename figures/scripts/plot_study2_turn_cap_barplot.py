"""
Study 2 (on-demand/voluntary map tools vs. baseline) -- % of trials
hitting the turn cap, by map condition, same convention as
figures/scripts/plot_study1_turn_cap_barplot.py, extended to Study 2's 5
...
Writes figures/study2_turn_cap_barplot.png.

Usage:
    python3 figures/scripts/plot_study2_turn_cap_barplot.py
"""
import os
...
OUT_PNG = os.path.join(_ROOT, "figures", "study2_turn_cap_barplot.png")
