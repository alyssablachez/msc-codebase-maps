"""
Study 1 -- pooled cost violin plot by map condition, same convention as
plot_study1_f1_violinplot.py.

Reads data/compiled_results_combined.pkl directly.
Writes figures/study1_cost_violinplot.png.

Usage:
    python3 figures/scripts/plot_study1_cost_violinplot.py
"""
import os
...
OUT_PNG = os.path.join(_ROOT, "figures", "study1_cost_violinplot.png")
