...
the "temporal_frequency" tool-based-retrieval condition (see DEVLOG 2026-07-16).
...
Usage:
    python3 harness/run_trial_temporal_frequency.py --model claude-sonnet-4-6 \
