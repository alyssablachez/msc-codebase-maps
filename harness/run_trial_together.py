...
Usage:
    python3 harness/run_trial_together.py --model together_ai/... --task 0 --map none
    python3 harness/run_trial_together.py --model together_ai/... --task 4 --map ast --max-turns 15
"""
# Together AI variant of run_trial.py
# LiteLLM's Together AI provider rejects tools/tool_choice at parameter
# validation unless explicitly whitelisted via allowed_openai_params.
# All other logic is identical to run_trial.py.
import argparse
import json
import os
import pickle
