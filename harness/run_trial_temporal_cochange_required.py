...
NO_TOOL_CALL_REJECTION_MESSAGE = (
    "You stopped without calling lookup_cochange or submit_answer. "
    "You must call lookup_cochange before this trial can end — call it on "
...
GATE_REMINDER_CLAUSE = (
    ...
    "lookup_cochange at least once — if you haven't yet, call it now so "
